...
def create_trip_post(request):
    ...
    return render(request, 'roadTripper/create_trip_post.html', {'template_data': template_data})
...
def trip_feed(request):
    ...
    return render(request, 'roadTripper/trip_feed.html', {'template_data': template_data})
