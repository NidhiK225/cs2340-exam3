...
def trip_feed(request):
    ...
    return render(request, "roadTripper/tripFeed.html", {"posts": posts}, {"saved_post_ids": saved_post_ids})
...
def saved_posts(request):
    ...
    return render(request, 'roadTripper/saved_posts.html', {
        'posts': posts
    })
@login_required
def save_post(request, post_id):
    ...
    if not created:
        saved.delete()  # unsave if already saved
